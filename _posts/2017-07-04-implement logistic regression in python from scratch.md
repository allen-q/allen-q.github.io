...
The logistic function can take any real input {\displaystyle t} t, ( {\displaystyle t\in \mathbb {R} } {\displaystyle t\in \mathbb {R} }) , whereas the output always takes values between zero and one[14] and hence is interpretable as a probability. The logistic function {\displaystyle \sigma (t)} \sigma (t) is defined as follows:
